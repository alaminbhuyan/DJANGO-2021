...
class SignUpForm(UserCreationForm):
    first_name = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Enter your FirstName'}), help_text='Required',error_messages={'required' : 'Enter your First Name'})

    last_name = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Enter your LastName'}), help_text='Required',error_messages={'required' : 'Enter your Last Name'})
    ...
    password1 = forms.CharField(widget=forms.PasswordInput(attrs={'class':'form-control', 'placeholder':'Enter your password'}), label="Password:",error_messages={'required' : 'Enter your Password'})

    password2 = forms.CharField(label='Confirm Password (Again)', widget=forms.PasswordInput(attrs={'class':'form-control', 'placeholder':'Re-enter your password'}),error_messages={'required' : 'Enter your Password'})
