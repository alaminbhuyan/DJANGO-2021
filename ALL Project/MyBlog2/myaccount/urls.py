...
urlpatterns = [
    ...
    path(route='forgetPassword/', view=views.forgetPassword, name="forgetPassword"),
    path(route='setNewPassword/<str:token>/', view=views.setNewPassword, name="setNewPassword"),
]